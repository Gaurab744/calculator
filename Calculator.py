# -*- coding: utf-8 -*-
"""
Created on Sun Jun 20 09:59:04 2021
...
round_btn = Button(btnrow2, text="round", font="Segoe 10 bold", relief=GROOVE, bd=0, command=round_clicked, fg="white", bg="#333333")
...
mod_btn = Button(btnrow2, text="%", font="Segoe 21", relief=GROOVE, bd=0, command=mod_clicked, fg="white", bg="#333333")
mod_btn.pack(side=LEFT, expand=TRUE, fill=BOTH)

pi_btn = Button(btnrow2, text="π", font="Segoe 18", relief=GROOVE, bd=0, command=pi_clicked, fg="white", bg="#333333")
